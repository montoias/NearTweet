...
public class SimWifiP2pBroadcastReceiver extends BroadcastReceiver {
    ...
    private NetworkManagerService mActivity;

    public SimWifiP2pBroadcastReceiver(NetworkManagerService activity) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (SimWifiP2pBroadcast.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
        	...
        	SimWifiP2pDeviceList gdeviceList = (SimWifiP2pDeviceList) intent.getSerializableExtra(SimWifiP2pBroadcast.EXTRA_DEVICE_LIST);
        	
        	ginfo.print();
    		Toast.makeText(mActivity, "Network membership changed", Toast.LENGTH_SHORT).show();	
    		
    		mActivity.getConnectionManager().updateSockets(ginfo, gdeviceList);
